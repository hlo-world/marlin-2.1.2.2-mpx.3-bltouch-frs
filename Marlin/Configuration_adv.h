 ...
 * [2024-06-13 hlo-world] Set K at 0.06, drawing reference to https://github.com/MarlinFirmware/Marlin/issues/10156
 */
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.145       // (mm) Compression length applying to all extruders
  #endif
