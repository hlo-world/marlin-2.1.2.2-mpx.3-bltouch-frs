...
void menu_main() {
  ...
  if (busy) {
    ...
    SUBMENU(MSG_TUNE, menu_tune);
      ...
      if (card_detected) {
        if (!card_open) {
          // [2024-04-21 hlo-world] Commented this out so Change Media menu item doesn't appear
          // #if HAS_SD_DETECT
  ...
  // [2024-04-21 hlo-world] Moved "Change Filament" menu item to just below "Temperature" menu item
