 ...
 */
//DEFAULT_FROM_HICTOP_FIRMWARE = 115200
...
#define CUSTOM_MACHINE_NAME "Printerino"
 ...
 */
  ...
  #define TEMP_SENSOR_REDUNDANT_MAX_DIFF  12.5 // (°C) Temperature difference that will trigger a print abort. Added 2.5C for those cold morning startups.
#endif
...
// X Axis, 3200 / 20 tooth, / 2.00mm pitch = 200*16 / 20 / 2 = 80 :: (STEPS_PER_REVOLUTION_X / IDLER_TEETH_X / BELT_PITCH_X)
// Y Axis, 3200 / 20 tooth, / 2.00mm pitch = 200*16 / 20 / 2 = 80 :: (STEPS_PER_REVOLUTION_X / IDLER_TEETH_X / BELT_PITCH_X)
// Z Axis, 3200 / m8 screwrod 1.25mm pitch = 200*16 / 1.25 = 2560 :: (STEPS_PER_REVOLUTION_Z / PITCH_OF_Z_ROD)
// Z Axis, 3200 / lead 2mm pitch (1-start) = 200*16 / 2.00 = 1600 :: (STEPS_PER_REVOLUTION_Z / PITCH_OF_Z_ROD)
// Z Axis, 3200 / lead 4mm pitch (2-start) = 200*16 / 4.00 =  800 :: (STEPS_PER_REVOLUTION_Z / PITCH_OF_Z_ROD)
 ...
 */
  ...
  // [2024-06-13 hlo-world] Set Junciton Deviation formulaically instead of hardcoding it
 ...
 */
#define S_CURVE_ACCELERATION // Added from HICTOP settings
 ...
 *
 */
#define NOZZLE_TO_PROBE_OFFSET { -17.7, -47.0, -1.50 }
